    ...
    <>
      <div class="background">
        <div class="parent">
          <div class="div1">
            <div
              class={gameState?.playerTurn === "player1" ? "current-turn" : ""}
            >
              {gameState !== undefined ? (
                <Player
          ...
          <div class="div2">
            <div
              class={gameState?.playerTurn === "player2" ? "current-turn" : ""}
            >
              {gameState !== undefined ? (
                <Player
          ...
          <div class="div6">
            <div
              class={gameState?.playerTurn === "player3" ? "current-turn" : ""}
            >
              {gameState !== undefined ? (
                <Player
          ...
          <div class="div7">
            <div
              class={gameState?.playerTurn === "player4" ? "current-turn" : ""}
            >
              {gameState !== undefined ? (
                <Player
          ...
          <div class="div8">
            <div
              class={gameState?.playerTurn === "player5" ? "current-turn" : ""}
            >
              {gameState !== undefined ? (
                <Player
